            ...
            <Div_navbar>
              <DivHeader>
                ...
                <Nav>
                  <Ul_header>
                    <li>
                      <A_header href='#home'>Home</A_header>
                    </li>
                    <li>
                      <A_header href='#timeline'>Timeline</A_header>
                    </li>
                    <li>
                      <A_header href='#possibilities'>Possibilities</A_header>
                    </li>
                    <li>
                      <A_header href='#trend'>Trend</A_header>
                    </li>
                  </Ul_header>
                </Nav>
              </DivHeader>
