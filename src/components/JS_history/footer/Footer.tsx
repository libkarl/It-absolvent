...
const Footer = () => {
  return (
    <div>
      <div className='bg-white pt-20 lg:pt-[120px] pb-10 lg:pb-20 relative z-10 '>
        <div className='container mx-auto'>
          <div className='flex flex-wrap -mx-4 ml-52'>
            <div className='w-full sm:w-2/3 lg:w-3/12 px-4'>
              <div className='w-full mb-10 ml-10'>
                <a href='javascript:void(0)' className='inline-block max-w-[160px] mb-6'>
                  <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Unofficial_JavaScript_logo_2.svg/512px-Unofficial_JavaScript_logo_2.svg.png'></img>
                </a>
            ...
            <div className='w-full sm:w-1/2 lg:w-3/12 px-4 margin mt-10 ml-16'>
              <div className='w-full mb-10 ml-52'>
                ...
                <p className='text-base text-body-color'>&copy; 2022 WebDevEducation</p>
              </div>
            </div>
          </div>
        </div>
