export const availablePics: { [index: string]: string } = {
  help: 'https://images.pexels.com/photos/52608/pexels-photo-52608.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
  webdesign:
